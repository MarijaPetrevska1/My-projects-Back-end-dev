...
namespace SecurityLab.Services
{
    public class AuthService
    {
        ...
        // --- Испраќање OTP на мејл ---
        private void SendOtpEmail(string toEmail, string otp)
        {
            var message = new MimeMessage();
            message.From.Add(new MailboxAddress("SecurityLab", "your_email@gmail.com")); 
            ...
            client.Authenticate("your_email@gmail.com", "your_email_password"); 
            client.Send(message);
